        ...
        <div className="cart-item">
          ...
          <div className="right-block">
            ...
            <div className="cart-item-actions">
                <img alt="increase"  onClick={()=>props.onIncreaseQuantity(props.product)} className="action-icons" src="https://cdn-icons.flaticon.com/png/512/3303/premium/3303893.png?token=exp=1641638187~hmac=9fe2cdfccc40b1c20f09f0a5d4c678d8"
               />
